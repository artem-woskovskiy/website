...
-- CreateEnum
CREATE TYPE "PlanCode" AS ENUM ('HOBBY', 'PRO', 'TEAM');
...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('ROBOKASSA_STUB', 'ROBOKASSA');
...
CREATE TABLE "Plan" (
    ...
    "panesLimit" INTEGER NOT NULL DEFAULT 4,
    "workspacesLimit" INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE "Payment" (
    ...
    "userId" TEXT NOT NULL,
    "subscriptionId" TEXT,
    "provider" "PaymentProvider" NOT NULL DEFAULT 'ROBOKASSA_STUB',
